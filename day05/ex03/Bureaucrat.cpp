...
/*   Updated: 2019/01/13 13:39:03 by zweng            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (this->_grade < form.eGrade())
	{
		std::cout << "Bureaucrat " << this->_name << " executes "
			<< form.name() << std::endl;
		form.execute(*this);
	}
	else
		std::cout << "Bureaucrat " << this->_name <<
			" grade is too low (" << this->_grade << "). They need a grade of "
			<< form.eGrade() << " to execute " << form.name() << std::endl;
}
